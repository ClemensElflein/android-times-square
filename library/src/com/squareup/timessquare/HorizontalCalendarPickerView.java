 ...
 */
public class HorizontalCalendarPickerView extends ViewPager {
	...
	private final HorizontalCalendarPickerView.MonthAdapter adapter;
	...
	private class MonthAdapter extends PagerAdapter {
		...
		private Queue<MonthView> convertViews = new LinkedList<MonthView>();
		...
		public Object instantiateItem(ViewGroup container, int position) {
			MonthView monthView = convertViews.poll();

			if (monthView == null) {
				monthView = MonthView.create(container, inflater,
		...
		public void destroyItem(ViewGroup container, int position, Object object) {
			...
			convertViews.add((MonthView) object);
		}
